...
class ProjectCBV:
    ...
    async def get(self, project_id: UUID4) -> Project:
    ...
    async def create(self, project: Project) -> Response:
    ...
    async def update(self, project: Project) -> Response:
        """Updating an existing Project"""

    @router.delete(
        "/{project_id}", status_code=status.HTTP_204_NO_CONTENT, response_class=Response
    )
    async def delete(self, project_id: UUID4) -> Response:
        """Deleting a Project"""
