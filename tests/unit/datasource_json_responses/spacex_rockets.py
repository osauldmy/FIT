PAYLOAD_SPACEX_ROCKETS = [
    ...
    },
    {
        ...
        by SpaceX for the reliable and safe transport of satellites and the Dragon \
    ...
    },
    {
        ...
        (119,000 lb)--a mass equivalent to a 737 jetliner loaded with passengers, \
        crew, luggage and fuel--Falcon Heavy can lift more than twice the payload \
        of the next closest operational vehicle, the Delta IV Heavy, at one-third \
        the cost.",
    ...
    },
    {
        ...
        transportation system designed to service all Earth orbit needs as well as \
        the Moon and Mars. This two-stage vehicle — composed of the Super Heavy \
        rocket (booster) and Starship (ship) — will eventually replace Falcon 9, \
